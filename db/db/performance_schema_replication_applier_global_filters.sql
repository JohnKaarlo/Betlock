...
--
-- Dumping data for table `replication_applier_global_filters`
--

LOCK TABLES `replication_applier_global_filters` WRITE;
/*!40000 ALTER TABLE `replication_applier_global_filters` DISABLE KEYS */;
/*!40000 ALTER TABLE `replication_applier_global_filters` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-17 14:02:26
